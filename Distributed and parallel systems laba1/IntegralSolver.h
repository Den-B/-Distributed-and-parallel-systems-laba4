...
private:
	...
	static coordinates goForward(coordinates workArea, double& currentX, double& currentY, double stepX, double stepY);
	static bool isPossibleToGoForward(coordinates workArea, double currentX, double currentY, double stepX, double stepY);
...
public:
	...
	static double solveOpenMP(coordinates baseCoordinates, double(*function)(double xCoordinate, double yCoordinate), int numberOfThreads, int xFragmentation, int yFragmentation);
